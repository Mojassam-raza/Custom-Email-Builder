...
import toast from 'react-hot-toast';
 ...
 const SignupSchema = Yup.object().shape({
   name: Yup.string()
     .min(2, 'Too Short!')
     .max(50, 'Too Long!')
     .required('Name Likhdo Bhai Plizzz 🙌'),
   email: Yup.string().email('Invalid email').required('Email Likhdo Bhai Plizzz 🙌'),
   password: Yup.string().required('Password Likhdo Bhai Plizzz 🙌')
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type="text"
                      ...
                      className="border py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" aria-describedby="name-error" />
                  ...
                  </div>
                  {
                    (signupForm.errors.name && signupForm.touched.name) && (
                      <p className="text-xs text-red-600 mt-2" id="error-name">
                ...
                <div>
                  ...
                  </div>
                  {
                    (signupForm.errors.email && signupForm.touched.email) && (
                      <p className="text-xs text-red-600 mt-2" id="error-email">
                ...
                <div>
                  ...
                  </div>
                  {
                    (signupForm.errors.password && signupForm.touched.password) && (
                      <p className="text-xs text-red-600 mt-2" id="error-password">
                ...
                <div>
                  ...
                  </div>
                  {
                    (signupForm.errors.confirmPassword && signupForm.touched.confirmPassword) && (
                      <p className="text-xs text-red-600 mt-2" id="error-confirmPassword">
